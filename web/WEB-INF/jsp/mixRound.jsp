    ...
    <div class="right">
      <table class="flightDetail">
        <tr>
          ...
          <td>${connect['0'].arriveCode} <b><fmt:formatDate value="${connect['0'].arriveTime}" pattern="HH:mm"/></b></td>
        ...
        <tr>
          <td>${connect['1'].departCode} <b><fmt:formatDate value="${connect['1'].departTime}" pattern="HH:mm"/></b></td>
    ...
    <div class="transferDetail">
      ...
      <div class="departDetail">
        <table>
          ...
          <tr>
            <td colspan="5"><div class="subTitle">Arrive : ${airNames[connect['0'].arriveCode]}(${connect['0'].arriveCode})</div></td>
          </tr>
        </table>
      </div>
        <div class="departDetail">
          ...
          <table>
            <tr>
              <td colspan="5"><div class="subTitle">Depart :&nbsp;${airNames[connect['1'].departCode]}(${connect['1'].departCode})</div></td>
            </tr>
            <tr>
              <td>
